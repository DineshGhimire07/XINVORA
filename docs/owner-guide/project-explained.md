# XINVORA — Project Explained (Owner Guide)

## What is XINVORA?
XINVORA is a high-end luxury lifestyle and fashion e-commerce platform. It provides a modern, fast, and secure online shopping experience where customers can browse curated apparel collections, customize options (such as color and size), add items to their shopping cart, and complete orders.
...
- **Orders & Inventory Management**: View new orders, update order statuses, and track live stock counts.
- **Discount & Promotions Manager**: Create coupon codes, set percentage/amount discounts, and highlight "Off Section" promotional banners.
- **Content CMS**: Customize the homepage hero banner, luxury editorial sections, and login page images directly from the admin panel.
- **Executive Analytics Dashboard (`/admin/cdp`)**: Track gross/net revenue, average order value (AOV), conversion funnels, top-selling products, and top search queries.
