    ...
    <div className="w-full space-y-6 sm:space-y-7 animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
        ...
        <Button
          type="submit"
          disabled={isPending}
          className="w-full h-11 sm:h-12 bg-[#8C6D58] hover:bg-[#775B47] text-white font-bold text-xs sm:text-sm uppercase tracking-[0.2em] rounded-md sm:rounded-lg transition-all duration-300 shadow-sm active:scale-[0.99] flex items-center justify-center gap-2"
        >
          {isPending ? (
            <>
      ...
      <div className="pt-5 border-t border-neutral-200/60 flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-[11px] sm:text-xs text-neutral-400">
        <span className="flex items-center gap-1">
          <LockIcon className="h-3.5 w-3.5 text-neutral-400 shrink-0" />
          Secure checkout
        </span>
