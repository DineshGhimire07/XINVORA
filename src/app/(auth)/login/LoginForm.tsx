    ...
    <div className="w-full space-y-8 animate-fade-in">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-neutral-500 font-normal leading-relaxed max-w-sm mx-auto">
          Sign in to continue your editorial shopping experience.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2 text-left">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 h-11 bg-white/70 border-neutral-200 focus:border-neutral-800 text-xs text-neutral-900 rounded-md transition-colors placeholder:text-neutral-400"
            />
          </div>
          {fieldErrors.email && (
            <p className="text-[11px] text-red-500 font-medium mt-1">{fieldErrors.email[0]}</p>
          )}
        </div>
        ...
        <div className="space-y-2 text-left">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="••••••••••••"
              className="pl-10 pr-10 h-11 bg-white/70 border-neutral-200 focus:border-neutral-800 text-xs text-neutral-900 rounded-md transition-colors placeholder:text-neutral-400"
            />
            <button
              type="button"
              disabled={isPending}
          ...
          {fieldErrors.password && (
            <p className="text-[11px] text-red-500 font-medium mt-1">{fieldErrors.password[0]}</p>
          )}
          ...
          <div className="flex justify-end pt-1">
            <a
              ...
              className="text-[11px] text-neutral-500 hover:text-neutral-900 transition-colors underline underline-offset-2"
            >
        ...
        <Button
          type="submit"
          disabled={isPending}
          className="w-full h-11 bg-[#8C6D58] hover:bg-[#775B47] text-white font-bold text-xs uppercase tracking-[0.2em] rounded-md transition-all duration-300 shadow-sm active:scale-[0.99] flex items-center justify-center gap-2"
        >
          {isPending ? (
            <>
      ...
      <div className="pt-6 border-t border-neutral-200/50 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-[10px] text-neutral-400">
