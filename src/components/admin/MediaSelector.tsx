              ...
              return (
                <div key={i} className="flex flex-col gap-1">
                  ...
                  <button 
                    ...
                    className="absolute top-1.5 right-1.5 bg-red-600/90 text-white w-6 h-6 rounded flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-xs font-bold"
                    title="Remove photo"
                  >
                    ×
                  </button>
                ...
                <div className="flex items-center justify-between gap-1 px-0.5">
                  <button
                    ...
                    className="flex-1 py-1 bg-admin-surface border border-admin-border text-admin-text-primary text-[10px] font-semibold rounded hover:bg-admin-content disabled:opacity-30 disabled:pointer-events-none transition-colors flex items-center justify-center gap-1"
                  >
                    ◀ Left
                  </button>
                  <button
